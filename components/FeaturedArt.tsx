...
export default function FeaturedArt() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 mt-16 max-w-7xl mx-auto px-4 sm:px-6">
        {items.map((item) => (
  ...
  return (
    ...
    >
      ...
      <div className="p-3 text-sm space-y-2">
        <div className="font-semibold opacity-80">{item.title || "Untitled"}</div>
